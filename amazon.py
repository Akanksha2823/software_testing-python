...
# if _name_ =='_main_':
s = Service("C:\software testing\chrom\chromedriver.exe")
...
time.sleep(4)
driver.find_element(By.XPATH ,"/html/body/div[1]/div[1]/div[2]/div/div/div/div/span/form/div[1]/input").send_keys("8217262565")
time.sleep(6)
driver.find_element(By.XPATH ,"/html/body/div[1]/div[1]/div[2]/div/div/div/div/span/form/span/span/input").click()
time.sleep(5)
driver.find_element(By.XPATH ,"/html/body/div[2]/div[1]/div[2]/div/div[2]/div/div[2]/div/form/div/div[1]/input").send_keys("Hello123")
time.sleep(5)
driver.find_element(By.XPATH,"/html/body/div[2]/div[1]/div[2]/div/div[2]/div/div[2]/div/form/div/div[2]/span/span/input").click()
time.sleep(6)
